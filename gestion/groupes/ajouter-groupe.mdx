...
* **Établissement :** L'établissement d'origine des étudiants (ex: "Lycée Saint-Louis", "Université de Tunis"). Ce champ est optionnel.
...
* Chaque contact a un **type** (ex: "Email") et une **donnée** (ex: "groupe.maths@exemple.com").
